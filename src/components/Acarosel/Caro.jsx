      ...
      <div id="carosel-innr" className="carousel-inner">
        ...
        <div id="coont" className="carousel-item active">
          <video autoPlay muted loop>
            <source
              src="https://www.astonmartin.com/-/media/models---vanquish/homepage/video/240818__website_launch_16x9.mp4?rev=e9a09fc68bc14bfcb6fb53ee77cfca0c"
              type="video/mp4"
            />
          </video>

          <div className="contenttt">
            <span>ZENITH.DRIVEN</span>
            <h1>Vanquish</h1>
            <br />
